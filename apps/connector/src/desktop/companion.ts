...
export const buildPowerShellContinueScript = (
  ...
  return [
    ...
    "    $primaryButton = Find-CodexRelayPrimaryThreadButton $candidate",
    "    if ($null -ne $primaryButton -and (Invoke-CodexRelayAutomationElement $primaryButton 1)) {",
    "      Start-Sleep -Milliseconds 400",
    "      return $candidateName.Trim()",
    "    }",
    "    if (Invoke-CodexRelayAutomationElement $candidate 2) {",
    "      Start-Sleep -Milliseconds 400",
    "      return $candidateName.Trim()",
    "    }",
    "  }",
    ...
    "        return $name",
    "      }",
    "      if (Invoke-CodexRelayAutomationElement $threadItem 2) {",
    "        Start-Sleep -Milliseconds 400",
    "        return $name",
    "      }",
    "    }",
