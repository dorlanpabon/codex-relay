...
export const buildPowerShellContinueScript = (
  ...
  return [
    ...
    "}",
    "function Invoke-CodexRelayAutomationElement($element) {",
    ...
    "  if (-not (Invoke-CodexRelayAutomationElement $projectButton)) { return $null }",
    ...
    "    if (Invoke-CodexRelayAutomationElement $candidate) {",
    ...
    "    if ($null -ne $threadItem -and (Invoke-CodexRelayAutomationElement $threadItem)) {",
    "      Start-Sleep -Milliseconds 400",
    "      return $name",
    "    }",
    "    $button = Find-CodexRelayExactNamedElement $root [System.Windows.Automation.ControlType]::Button $name",
    "    if ($null -ne $button -and (Invoke-CodexRelayAutomationElement $button)) {",
    "      Start-Sleep -Milliseconds 250",
    "      return $name",
    "    }",
    "  }",
