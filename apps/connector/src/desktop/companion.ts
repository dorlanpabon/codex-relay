...
export const buildPowerShellContinueScript = (
  ...
  return [
    ...
    "    $name = $label.Trim()",
    "    $matches = $root.FindAll([System.Windows.Automation.TreeScope]::Descendants, $buttonCondition)",
    ...
    "      if ([string]::Equals($candidateName.Trim(), $name, [System.StringComparison]::OrdinalIgnoreCase)) {",
